         ...
         */
         ...
         switch(mov){
             ...
             case Canibal:
                    ...
                    if (barcaAlaIzquierda() && (estadoMC.getMisionerosDer() == 0 || estadoMC.getCanibalesDer() + 1 <= estadoMC.getMisionerosDer())){
                    ...
                    else if (!barcaAlaIzquierda() && (estadoMC.getCanibalesIzq() + 1 <= estadoMC.getMisionerosIzq() || estadoMC.getMisionerosIzq() == 0)){
             ...
             case Misionero:
                  ...
                  */
                 if (barcaAlaIzquierda() && (estadoMC.getMisionerosIzq() - 1 >= estadoMC.getCanibalesIzq() || estadoMC.getMisionerosIzq() - 1 == 0)){
                 ...
                 else if(!barcaAlaIzquierda() && (estadoMC.getMisionerosDer() - 1 >= estadoMC.getCanibalesDer() || estadoMC.getMisionerosDer() - 1 == 0)){
             ...
             case MisioneroYCanibal:
                 ...
                 /*if (barcaAlaIzquierda() && (estadoMC.getMisionerosIzq() - 1 >= estadoMC.getCanibalesIzq() - 1  || estadoMC.getMisionerosIzq() - 2 == 0)){
                    */
                 if (barcaAlaIzquierda() && estadoMC.getMisionerosDer() + 1 >= estadoMC.getCanibalesDer() + 1){
                       estadoMC.setMisionerosIzq(estadoMC.getMisionerosIzq() - 1);
                       estadoMC.setCanibalesIzq(estadoMC.getCanibalesIzq() - 1);
                       estadoMC.cambiaDeOrilla();
                       return true;
                 ...
                 else if(!barcaAlaIzquierda() && estadoMC.getMisionerosIzq() + 1 >= estadoMC.getCanibalesIzq() + 1){
             ...
             case DosMisioneros:
                  ...
                  * de misioneros que canibales o no queda ningún misionero.
                  */
                 if (barcaAlaIzquierda() && (estadoMC.getMisionerosIzq() - 2 >= estadoMC.getCanibalesIzq() || estadoMC.getMisionerosIzq() - 2 == 0)){
                 ...
                 else if(!barcaAlaIzquierda() && (estadoMC.getMisionerosDer() - 2 >= estadoMC.getCanibalesDer() || estadoMC.getMisionerosDer() - 2 == 0)){
             ...
             case DosCanibales:
                   ...
                   // refactoriza barcaAlaIzquierda.
                    /// hay que chequear que el canibal que queremos cruzar existe.
                    if (barcaAlaIzquierda() && (estadoMC.getMisionerosDer() == 0 || estadoMC.getCanibalesDer() + 2 <= estadoMC.getMisionerosDer())){
                    ...
                    else if (!barcaAlaIzquierda() && (estadoMC.getCanibalesIzq() + 2 <= estadoMC.getMisionerosIzq() || estadoMC.getMisionerosIzq() == 0)){
